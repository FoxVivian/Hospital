/*
  # Đơn giản hóa hệ thống mật khẩu

  1. Thay đổi cột password_hash thành password
  2. Cập nhật dữ liệu mẫu với mật khẩu đơn giản
  3. Thêm dữ liệu mẫu đầy đủ cho hệ thống
*/
...
TRUNCATE TABLE lab_test_templates CASCADE;
TRUNCATE TABLE service_prices CASCADE;
TRUNCATE TABLE insurance_providers CASCADE;
TRUNCATE TABLE patients CASCADE;
TRUNCATE TABLE users CASCADE;

-- 3. INSERT USERS (Nhân viên y tế)
INSERT INTO users (id, email, password, user_type, role, name, phone, department, avatar) VALUES
  ('11111111-1111-1111-1111-111111111111', 'admin@hospital.com', '123456', 'staff', 'admin', 'Quản trị viên', '0281234567', 'IT', 'https://images.pexels.com/photos/5452274/pexels-photo-5452274.jpeg?auto=compress&cs=tinysrgb&w=150&h=150&dpr=2'),
  ('22222222-2222-2222-2222-222222222222', 'doctor@hospital.com', '123456', 'staff', 'doctor', 'BS. Nguyễn Văn A', '0901234567', 'Nội khoa', 'https://images.pexels.com/photos/5452293/pexels-photo-5452293.jpeg?auto=compress&cs=tinysrgb&w=150&h=150&dpr=2'),
  ('33333333-3333-3333-3333-333333333333', 'nurse@hospital.com', '123456', 'staff', 'nurse', 'Y tá Trần Thị B', '0912345678', 'Khoa Nội', 'https://images.pexels.com/photos/5452201/pexels-photo-5452201.jpeg?auto=compress&cs=tinysrgb&w=150&h=150&dpr=2'),
  ('44444444-4444-4444-4444-444444444444', 'pharmacist@hospital.com', '123456', 'staff', 'pharmacist', 'Dược sĩ Lê Văn C', '0923456789', 'Dược', 'https://images.pexels.com/photos/5452268/pexels-photo-5452268.jpeg?auto=compress&cs=tinysrgb&w=150&h=150&dpr=2'),
  ('55555555-5555-5555-5555-555555555555', 'lab@hospital.com', '123456', 'staff', 'lab_technician', 'KTV Phạm Thị D', '0934567890', 'Xét nghiệm', 'https://images.pexels.com/photos/5452299/pexels-photo-5452299.jpeg?auto=compress&cs=tinysrgb&w=150&h=150&dpr=2'),
  ('66666666-6666-6666-6666-666666666666', 'doctor2@hospital.com', '123456', 'staff', 'doctor', 'BS. Lê Thị B', '0945678901', 'Sản khoa', 'https://images.pexels.com/photos/5452201/pexels-photo-5452201.jpeg?auto=compress&cs=tinysrgb&w=150&h=150&dpr=2'),
  ('77777777-7777-7777-7777-777777777777', 'doctor3@hospital.com', '123456', 'staff', 'doctor', 'BS. Trần Văn C', '0956789012', 'Ngoại khoa', 'https://images.pexels.com/photos/5452293/pexels-photo-5452293.jpeg?auto=compress&cs=tinysrgb&w=150&h=150&dpr=2');

-- 4. INSERT PATIENT USERS
INSERT INTO users (id, email, password, user_type, name, phone) VALUES
  ('aaaaaaaa-aaaa-aaaa-aaaa-aaaaaaaaaaaa', NULL, '123456', 'patient', 'Nguyễn Văn Nam', '0901234567'),
  ('bbbbbbbb-bbbb-bbbb-bbbb-bbbbbbbbbbbb', 'mai.tran@email.com', '123456', 'patient', 'Trần Thị Mai', '0912345678'),
  ('cccccccc-cccc-cccc-cccc-cccccccccccc', NULL, '123456', 'patient', 'Lê Văn Hùng', '0923456789'),
  ('dddddddd-dddd-dddd-dddd-dddddddddddd', 'hoa.pham@email.com', '123456', 'patient', 'Phạm Thị Hoa', '0934567890');
...
-- 14. INSERT INVOICES (Sửa payment_method để phù hợp với constraint)
INSERT INTO invoices (id, invoice_number, patient_id, appointment_id, services, medicines, lab_tests, subtotal, discount_amount, discount_percent, tax_amount, tax_percent, total_amount, paid_amount, remaining_amount, payment_method, status, created_by, due_date, paid_date, insurance_coverage, insurance_claim_number) VALUES
  ...
  ]', 330000, 25000, 7.6, 0, 0, 305000, 150000, 155000, 'cash', 'partial', '33333333-3333-3333-3333-333333333333', '2025-01-05', NULL, NULL, NULL);
